...
def read_img_movie(movie_path, uploaded_mv_file, mode):
    mv_file_path = None
    cap_file = None
...
def create_virtual_bg(button_stop, cap_file, mode, fps_val):
...
if __name__ == "__main__":
    ...
    if button_run == True:
        if mode == '動画ファイル選択' and uploaded_mv_file is None:
            ...
            create_virtual_bg(button_stop, cap_file, mode, fps_val)
